...
public class AmadeusConnect {
    ...
    // ========================================
    // ⭐ NUEVO: TRANSPORTE / TRANSFERS
    // ========================================
    
    /**
     * Buscar transfers (traslados privados)
     * @param startLocationCode Código IATA del origen (aeropuerto)
     * @param endAddressLine Dirección de destino
     * @param endCityName Ciudad de destino
     * @param endCountryCode Código del país (ej: "ES")
     * @param startDateTime Fecha y hora de recogida (ISO 8601: 2025-12-15T10:00:00)
     * @param passengers Número de pasajeros
     * @return Array de ofertas de transfer
     */
    public TransferOffering[] searchTransfers(
        ...
        logger.info("   Origen: {}, Destino: {} ({}), Pasajeros: {}", 
                   startLocationCode, endCityName, endCountryCode, passengers);
        
        try {
            Params params = Params
                .with("startLocationCode", startLocationCode.trim())
                .and("endAddressLine", endAddressLine.trim())
                .and("endCityName", endCityName.trim())
                .and("endCountryCode", endCountryCode.trim())
                .and("startDateTime", startDateTime.trim())
     ...
     * @param airportCode Código IATA del aeropuerto (ej: "MAD", "BCN")
     * @param cityName Nombre de la ciudad destino
     * @param countryCode Código del país (ej: "ES")
     * @param dateTime Fecha y hora ISO 8601
     * @param passengers Número de pasajeros
     * @return Array de transfers disponibles
     */
    public TransferOffering[] searchAirportTransfers(
        ...
        logger.info("✈️🚗 Búsqueda de transfers desde aeropuerto: {} a {}", 
                   airportCode, cityName);
        
        // Dirección genérica del centro de la ciudad
        String addressLine = "City Center, " + cityName;
